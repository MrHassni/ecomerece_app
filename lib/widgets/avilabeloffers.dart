...
class AvailabelOffers extends StatefulWidget {
  ...
  const AvailabelOffers(
      {Key? key, required this.index, required this.lengthOfList})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Card(
      margin: EdgeInsets.only(
          bottom: 15,
          right: widget.index == widget.lengthOfList - 1 ? 10 : 5,
                ...
                child: Row(
                  children: const [
                    ...
                    Text(
                      '30 min',
                      style:
                          TextStyle(color: Constants.kBlackColor, fontSize: 10),
                    ),
                  ],
                ),
              ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  '200mg',
                  style: TextStyle(color: Constants.kGreyColor, fontSize: 14),
                ),
                const SizedBox(
                  height: 5,
                ),
